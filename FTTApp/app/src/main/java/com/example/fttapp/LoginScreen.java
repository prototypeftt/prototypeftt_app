...
public class LoginScreen extends AppCompatActivity {
    ...
    private void changeActivity(){
        ...
        Button GoogleLogin = findViewById(R.id.GoogleLogButton);
        LogInButton.setOnClickListener(view -> loginUser());
        ToRegisterButton.setOnClickListener(view -> startActivity(new Intent(LoginScreen.this, RegisterScreen.class)));
